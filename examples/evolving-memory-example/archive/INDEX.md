...
> grep here. `id — one-line — quarter file (status)`.

- `legacy-soap-adapter` — SOAP adapter for the legacy billing vendor — 2026-Q2.md
- `csv-bulk-import` — CSV bulk-import endpoint for onboarding — 2026-Q2.md
- `ci-migration` — completed: CircleCI → GitHub Actions — 2026-Q2.md
