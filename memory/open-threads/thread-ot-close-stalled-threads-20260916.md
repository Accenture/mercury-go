- [x] **Close stalled threads (due) — dispositioned 2026-09-16 (first live exercise of `REVIEW.md` step 8).**
  Eric closed all three: `vbdi-lifecycle-direction` (94 sessions — plan shipped in v4.0.0, nothing dropped),
  `bp-sdlc-overlay` (157 — deliberately dropped; §12 process-neutral covers it; a real request reactivates),
