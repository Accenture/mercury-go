- [x] **Build a VBDI lifecycle layer — closed at the closure gate 2026-09-16 (stalled 94 sessions).**
  Outcome: every planned item shipped in v4.0.0 (2026-06-15) — the Vision (`memory/vision.md`),
  `docs/DESIGN-vbdi-lifecycle.md`, and the forward layer on the version ladder (`DECAY.md` §12); the
